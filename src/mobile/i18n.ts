  ...
  en: {
    translation: {
      ...
      devices: {
        ...
        scanAddedCount: "{{count}} device(s) added",
        ...
        renameHint: "Long-press a device to rename it",
        cancel: "Cancel",
        save: "Save",
        retry: "Retry",
  ...
  zh: {
    translation: {
      ...
      devices: {
        ...
        removeConfirmTitle: "移除设备",
        removeConfirm: "移除 {{name}}？",
        removeConfirmAction: "移除",
        errorUnreachable: "无法连接",
        errorRefused: "连接被拒",
        errorTimeout: "连接超时",
        errorUnknown: "错误",
